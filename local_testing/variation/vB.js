...
//           while (el && el.matches && el !== context2 && !(found = el.matches(selector2))) el = el.parentElement;
...
//         $addClass("body", "Thumbtack-145");
  
//         var interval = setInterval(function () {
//           waitFor(
//             () => document.querySelector(`div[class*="hero-header_filters"] h2 + div button`) ? true : false,
//             () => {
//               var number_content = document.querySelector(`div[class*="hero-header_filters"] h2 + div button`).textContent;
...
//               } else {
//                 document.querySelector(`[class*="hero-header_filters"] [class*="Type_title3"]`).innerHTML = "Check out " + result_number + " " + lowercaseProfessionResult + " near <span>" + loc + "</span>";
//               }
//               if (document.querySelector('[class*="hero-header_rootFlex"]>[class*=hero-header_heroHeaderExtendedHeight] picture+div h1')) {
//                 document.querySelector('[class*="hero-header_rootFlex"]>[class*=hero-header_heroHeaderExtendedHeight] picture+div h1').innerHTML = "Check out " + result_number + " " + lowercaseProfessionResult + " <span>near</span> <span>" + loc + "</span>";
//               }
...
//               }
//             } else {
//               var keyword_pk = window.__NEXT_DATA__.props.pageProps.frontDoorProps.results[0].seoProperties.url;
//               var updatedPK = "https://www.thumbtack.com" + keyword_pk;
//               $live('.m_absolute .bg-white form [data-test="hero-filters-cta"] span', "click", function (event2) {
//                 if (!isCloneChanges) {
//                   event2.preventDefault();
//                   if (updatedPK) {
//                     window.location.href = updatedPK;
//                   }
//                 }
//               });
//             }
