		...
		<div class="cre-t-5-draw-container">
			<div class="cre-t-5-draw-main">
				<div class="cre-t-5-draw-top">
					...
					<h1 class="cre-t-5-draw-sub-header">Start from scratch or choose from one of our beginner-friendly
						templates</h1>
				</div>
	...
	<div class="cre-81-Garden-Planner container-T-81" id="maximizeharvest">
		<div class="cre-81-Garden-Planner-inner">
			...
			<div class="cre-81-Protect-your-crops cre_coulmn_reverse gurulogo81">
				<div class="cre-81-graden-planer-text">
					<h1 class="cre-t-5-best-gardener-sub-header">See how it's done step-by-step
					</h1>
        ...
        waitForElement(".CRE-navStickyItem p", function () {
            setTimeout(function () {
                ...
                if (window.innerWidth > 1023) {
                    ...
                    var navLi = document.querySelectorAll('.Cre-StickyNav-mobile .CRE-navStickyItem p'); // Assuming sections represent the corresponding content
                    ...
                    window.addEventListener("scroll", function () {
                        ...
                        navLi.forEach(function (li) {
                            ...
                            if (li.getAttribute("dataid") === `#${current}`) {
                                ...
                                var container = document.querySelector('.Cre-StickyNav-mobile');
