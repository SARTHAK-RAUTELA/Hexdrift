(function () {
  try {
      ...
      function insertProductCards() {
          ...
          var productClasses = [
              '.single-day-ticket',
              '.seaworld-2024-fun-card',
              '[class*=aquatica-2024-fun-card]',
              '.any-day-ticket',
              '.two-park-ticket',
              '.three-park-ticket',
              '.four-park-ticket'
      ...
      function visibleTheCard() {
          ...
          if (selectedDayValue === "2") {
              if (parksValue === "seaworld" || parksValue === "seaworld,aquatica") {
                  ...
                  document.querySelector('.two-park-ticket').style.display = "block";
                  setheading(`This ticket match your criteria:`);
                  headingElem.style.display = 'block'
                  resultElem.style.display = 'none'
              } else if ((!parksGroup.getAttribute('value').includes('seaworld') && document.querySelectorAll('#parksGroup .selected').length == 1)) {
                  setheading(`This ticket match your criteria:`);
          ...
          if (selectedDayValue === "unlimited") {
              if (parksValue === "seaworld" || parksValue === "seaworld,aquatica") {
                  ...
                  var valueAttr1 = parksArray[0];  // First park
                  var valueAttr2 = parksArray[1];
