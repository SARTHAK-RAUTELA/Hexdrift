              ...
              if (!window.transactionEvenListnerActivated) {
                  ...
                  dataLayerlistioner(function (model, message) {
                      ...
                      if (message.event == "purchase") {
                          setTimeout(() => {
                              var revenue = message.ecommerce && message.ecommerce.value;
                              var products_cnt = message.ecommerce && message.ecommerce.items && message.ecommerce.items.length;
                              console.log(revenue, "revenue", products_cnt, "products_cnt");
