(function () {
  try {
    ...
    var curvedHtml = `
    <div class="${variation_name}-curved-container" style="display:none;">
    ...
    var textHtml = `
      <div class="${variation_name}-text-container" style="visibility:hidden;height:0;overflow:hidden;">
        <div class="${variation_name}-text-wrapper">
          <div class="${variation_name}-text-content">
            <div class="${variation_name}-custom-h1-wrapper">
              <div class="${variation_name}-custom-h1">Dine 
                <span class="cre-t-76-mobile-same-line">off-peak &amp;</span>
                <span class="cre-t-76-mobile-save">&nbsp;save 50%&nbsp;</span><br class="cre-t-76-break-1">
                on your<br class="cre-t-76-break-2"> entire meal
              </div>
            </div>
            <div class="${variation_name}-custom-p-wrapper">
              <div class="${variation_name}-custom-p">
Dine slightly earlier or later in the evening at thousands of top-rated restaurants and enjoy 50% off the food bill—for you and up to three guests.              </div>
            </div>
          </div>
        </div>
      </div>
    ...
    var bottomHtml = `
      <div class="${variation_name}-bottom-container" style="display:none;">
