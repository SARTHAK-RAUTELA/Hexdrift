(function () {
	try {
	  ...
	  var creSee = `<div class="cre-seeMore">
		<div class="cre-seeMore-wrapper">
			<div class="cre-seeMore-inner">
				<div class="cre-seeMore-left">
					<span>Show more</span>
				</div>
				<div class="Show-more-right">
					<svg aria-labelledby="svg-inline--fa-title-4WX0LqdnWapj" data-prefix="fas" data-icon="angle-down" class="svg-inline--fa fa-angle-down " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-testid="icon" width="16px"><title id="svg-inline--fa-title-4WX0LqdnWapj">chevron right</title><path fill="currentColor" d="M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z"></path></svg>
				</div>
			</div>
		</div>
	</div>`;
  
	  var creSubscribe = `<div class="cre-subsCribe">
		<div class="cre-subsCribe-wrapper">
			<div class="cre-subsCribe-inner">
				<p class="cre-subsCribe-text">Not ready to subscribe? <span>Buy a single issue instead</span></p>
			</div>
		</div>
	</div>`;
					  ...
					  <div class="cre-productdispla-left-img">
						<div class="cre-productdispla-left-wrapper">
						  <picture class="cre-productdispla-left-picture">
							...
							<source srcset="https://images.arcade.futurecdn.net/@prod/_fill_w220_h291/sylius/assets/images/de/c3/c2c4a070905fe77a7ef78013a127.jpg, https://images.arcade.futurecdn.net/@prod/_fill_w440_h582/sylius/assets/images/de/c3/c2c4a070905fe77a7ef78013a127.jpg 2x" media="(min-width: 414px)"><img decoding="async" loading="lazy" srcset="" src="https://images.arcade.futurecdn.net/@prod/_fill_w240_h318/sylius/assets/images/de/c3/c2c4a070905fe77a7ef78013a127.jpg" alt="Country Life" width="240px" height="318px" class="cre-productdispla-left-pictureImg"></picture>
						</div>
					  </div>
	...
	waitForElement('#magazinesize-select', function () {
	  ...
	  function init() {
		...
		waitForElement('.cre-productdispla-right-seeMore', function () {
			// setTimeout(function(){
			// 	var pHeight = document.querySelector('span.cre-productdispla-right-paragraph-innerSpan').offsetHeight
			// 	if(pHeight <= 115){
