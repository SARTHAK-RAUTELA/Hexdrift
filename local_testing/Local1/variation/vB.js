if (!window.location.href.includes("https://www.gendergp.com/next-steps/")) {
     ...
     <span class="bullet-bold">We organise private prescriptions for medical transitions so that you can quickly and easily access the care you need,</span>  with compassionate guidance every step of the way.
    ...
    "Without GenderGP, I would have had to wait 5-7 years for HRT through the NHS. I would be dead if it were not for GGP. Now I\u2019m 11 months on HRT, my life has done a 180\xB0.\u201D    
      ...
      `;
            waitFor(
                ...
                () => {
                    console.log("Test_7v2 activated")
                    document.querySelector("body").classList.add("cre-7");
                    var sliderDiv_7 = document.querySelector("#welcome-gate");
                    if (!document.querySelector(".CRE-T7-hero-container")) {
                        sliderDiv_7 && sliderDiv_7.insertAdjacentHTML("beforebegin", CRET7hero);
                    }
                },
                {
                    interval: 50,
