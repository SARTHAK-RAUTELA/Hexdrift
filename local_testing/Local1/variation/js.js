        ...
        () => {
          ...
          if (document.querySelector('div[class*="hero-header_filters"] h2 + div button')) {
            ...
            if (window.location.href.startsWith(searchString)) {
              document.querySelector(`[class*="hero-header_filters"] [class*="Type_title3"]`, `html body  [class*="hero-header"] [class*="Type_title2"]`).textContent = "Check out   " + result_number + " " + lowercaseProfessionResult + " near you";
            }
            else {
              document.querySelector(`[class*="hero-header_filters"] [class*="Type_title3"]`,`html body  [class*="hero-header"] [class*="Type_title2"]`).innerHTML =
                "Check out " +
                result_number +
                " " +
            ...
            const searchString = "https://www.thumbtack.com/k/";
            if (window.location.href.startsWith(searchString)) {
              document.querySelector(`[class*="hero-header_filters"] [class*="Type_title3"]`, `html body  [class*="hero-header"] [class*="Type_title2"]`).textContent = "Check out   " + lowercaseProfessionResult + " near you";
            }
            else {
              document.querySelector(`[class*="hero-header_filters"] [class*="Type_title3"]`,`html body  [class*="hero-header"] [class*="Type_title2"]`).innerHTML =
                "Check out " +
