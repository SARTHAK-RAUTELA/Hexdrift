(function () {
    try {
      ...
      function addProducts(allLink) {
        var list = `
         <ul class='collapsibleMagazines cre-t-64_magazines-list'>
        `;
        ...
        list += `<li class='visiblecategory cre-t-64_redText'><a href=${allLink}>See All Magazines</a></li></ul>`;
  
        waitForElement(".categories-toggle", function () {
          document.querySelector(".categories-toggle").insertAdjacentHTML("beforebegin", '<li class="cre-t-64_mag-name"><span> Magazines A-Z<img src="/images/expand.png" class="expandImage az-expand-image" alt="Expand A-Z Magazines"></span>' + list + '</li>')
        }, 50, 15000)
      }
  
      function eventListener() {
        live(".cre-t-64_mag-name > span", "click", function () {
          document.querySelector(".cre-t-64_mag-name .az-expand-image").classList.toggle("rotateExpand");
          document.querySelector(".collapsibleMagazines").classList.toggle("cre-t-64_show");
        })
      }
      ...
      function init() {
        ...
        if (!document.querySelector("." + variation_name)) {
          ...
          waitForElement(".cre-t-64_magazines-list ", function () {
            if (!document.querySelector('.cre-t-64-searchBar')) {
              document.querySelector('.cre-t-64_magazines-list').insertAdjacentHTML('afterbegin', '<li class=" cre-t-64-searchBar visiblecategory"><i id="cre-t-magnify" class="fa-solid fa-magnifying-glass"></i><input type="text" id="cre-search-words-mobile" class="search-words ui-autocomplete-input" name="q" placeholder="Search magazines..." aria-label="Search our magazines" autocomplete="off"></li>')
            }
          }, 50, 15000)
