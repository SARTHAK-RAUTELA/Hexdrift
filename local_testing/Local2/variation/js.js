        ...
        <li class="cre-smallerHide cre-mega-menu-trigger cre-dropdowns-2022" id="cre-atoz-megamenu-display-2022"
            ...
            <div id="cre-atoz-mega-menu-2022" class="row cre-megamenu cre-atoz-mega-menu">
                <ul class="cre-menu-row">
					...
					<li class="">
                        <a class="cre-wholebox navigationevent"
                            href="/az-magazines/54314235/the-week-subscription.thtml">The Week</a>
                    </li>
                    <li class="">
                        <a class="cre-wholebox navigationevent"
		...
		function init() {
			...
			waitForElement('#promCodeBanner>.col>strong', function () {
				if (!document.querySelector('.cre-t-45-promo')) {
					document.querySelector('#promCodeBanner>.col>strong').insertAdjacentHTML('afterend', '<span class="cre-t-45-promo">Summer sale! Get 3 print issues from just £5. <a href="https://www.magazinesdirect.com/promotions/categories/summersale24/">Learn more</a></span>')
				}
