...
// Add or remove class based on the URL path  
const body = document.body;
if (
    window.location.pathname === '/tampa/tickets/fun-card-b/' ||
    window.location.pathname === '/tampa/tickets/fun-card/'
) {
    body.classList.add("funCardTicketPage");
} else if (body.classList.contains("funCardTicketPage")) {
    body.classList.remove("funCardTicketPage");
}
