...
`;
    ...
    function updateChanges() {
      waitForElement(".cre-t-51-cross-mobile", function () {
        document.querySelector('.cre-t-51-cross-mobile').addEventListener("click", function () {
          document.querySelector("body.cre-t-51-modal-open")?.classList.remove("cre-t-51-modal-open")
        })
      })
      ...
      document.addEventListener("click", function (e) {
        ...
        if (
          e.target.classList.contains("cre-t-51-cross") ||
