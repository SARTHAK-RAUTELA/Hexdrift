(function () {
    try {
        ...
        var helper = _$();
        var superUspBar = '<div class="cre-usp-bar"><span>SAVE $20/person - 2</span> Flight Super Saver Special</div>';
        var reviewRat = ' <span class="rating fa fa-star checked"></span>';
        var addContent =
            "" +
            '<div class="cre-iFly3-wrapper">' +
            '<div class="cre-iFly3-container">' +
            '<div class="cre-iFly3-main">' +
            '<div class="cre-iFly3-txtContent">' +
            '<div class="cre-iFly3-header">' +
            "<h3>A once in a lifetime experience you'll never forget</h3>" +
            '<div class="cre-bordered"></div>' +
            "</div>" +
            '<div class="cre-iFly3-contentReview">' +
            '<p>"100% recommended iFly!!! We did this as a family and had an amazing time"</p>' +
            "<span><span class='cre-iFly3-spaName'>- Carly </span>" +
            "<span class='cre-iFly3-spano'> o. </span>" +
            reviewRat +
            reviewRat +
            reviewRat +
            reviewRat +
            ...
            '<div class="cre-iFly3-step cre-iFly3-step1">' +
            '<div class="cre-step">' +
            ...
            "</div>" +
            '<div class="cre-iFly3-step cre-iFly3-step2">' +
            '<div class="cre-step">' +
            ...
            "</div>" +
            '<div class="cre-iFly3-step cre-iFly3-step3">' +
            '<div class="cre-step">' +
            ...
            "</div>" +
            '<div class="cre-iFly3-step cre-iFly3-step4">' +
            '<div class="cre-step">' +
            ...
            "</div>" +
            '<div class="cre-iFly3-step cre-iFly3-step5">' +
            '<div class="cre-step">' +
                ...
                if (calloutLenght.length >= 4) {
                    waitForElement('.categoryGroup .categoryLinkSelected div', function () {
                        ...
                        if (selector.innerHTML.indexOf('Buy a Gift') != -1 || selector.innerHTML.indexOf('buy a gift') != -1) {
                            addClass('body', 'cre-iFly3-prod')
                        }
                    })
                    clearInterval(intervalCallAgain);
                }
            }, 500);
            //start the countdown .cre-iFly3-prod .product-grid-item:not()
        ...
        /* Variation Init */
        function init() {
            document.body.classList.remove('cre-t-6');
            // document.body.classList.remove('cre-t-23');
            ...
            if (document.querySelector("body.cre-iFly3")) {
                if (!document.querySelector(".cre-iFly3-wrapper")) {
                    ...
                    function () {
                        helper.waitForElement(
                            ...
                            function () {
                                ...
                                var creSuperPrice = '<div class="cre-super-price"> <p>$' + updateSuperPr + '</p><span class = "cre-person">PER PERSON</span></div>';
                                !document.querySelector(".cre-super-price") &&
                                    document.querySelector(".cre-superSaver .cre-superSaver-row > .cre-quantity").insertAdjacentHTML("beforebegin", creSuperPrice);
                            },
                            50,
                            25000
                        );
                ...
                helper.waitForElement(
                    ...
                    function () {
                        if (!document.querySelector(".cre-usp-bar")) {
                            document.querySelector(".cre-superSaver").insertAdjacentHTML("beforebegin", superUspBar);
                        }
                    },
                    50,
                    25000
                ...
                helper.waitForElement(
                    ...
                    function () {
                        document.querySelector(".cre_fourFlights").insertAdjacentHTML("afterbegin", creFourBubble());
                    },
                    50,
                    25000
                );
                helper.waitForElement(
                    ...
                    function () {
                        document.querySelector(".cre_familyFlights").insertAdjacentHTML("afterbegin", creFamilyBubble());
                    },
                    50,
                    25000
                );
                helper.waitForElement(
                    ...
                    function () {
                        document.querySelector(".cre-quantity p").innerText = "Select the number of flyers";
                    },
                    50,
                    25000
                );
        ...
        helper.waitForElement('.categoryLinkSelected > div', function () {
            if (document.querySelector('.categoryLinkSelected > div').textContent.trim().toLowerCase() === 'book a flight') {
                helper.waitForElement('.cre-iFly3', init, 500, 30000);
            }
        }, 250, 25000)

        helper.waitForElement(".primaryContainer .categoryLinkSelected, a .categoryLink", function () {
            if (window.location.href.includes('https://booking.iflyworld.com/mainstore?cid=0')) {
                helper.waitForElement('.cre-iFly3', init, 500, 30000);
            } else {
                init();
