    ...
    try {
        ...
        function init() {
            ...
            if (match && match[1]) {
                ...
                // Check if the data exists in the objectData
                if (objectData[pagePath] && objectData[pagePath][kwId]) {
                    ...
                    var headerElement = isMobile
                        ? document.querySelector('[class*="hero-header"] .hero_header_parent_mobile .hero_header_mobile') // Mobile selector
                        : document.querySelector('.hero_section .hero_header_parent .hero_header'); // Desktop selector
                    ...
                    // Set pro list title directly from objectData
                ...
                // If no match in objectData, check in uniqueDataObject
                if (uniqueDataObject[pagePath] && uniqueDataObject[pagePath][kwId]) {
                    var extractedNumberHeader = null;
                    var extractedNumberProList = null;

                    // Extract number from header (if any)
                    var spanElementHeader = document.querySelector('.hero_section [class*="hero_header_parent"] [class*="hero_header"]');
                    ...
                    // Extract number from pro list (if any)
                    ...
                    // Set header title dynamically with number extracted
                    var headerElement = document.querySelector('.hero_section .hero_header_parent_mobile .hero_header_mobile') ||
                        document.querySelector('.hero_section .hero_header_parent .hero_header'); // Mobile/desktop selectors
                    ...
                    // Directly set the pro list title from uniqueDataObject (no number extraction)
                    if (spanElementProList) {
                        var firstChildNodeProList = spanElementProList.childNodes[0];
                        if (firstChildNodeProList && firstChildNodeProList.nodeType === Node.TEXT_NODE) {
                            firstChildNodeProList.nodeValue = uniqueDataObject[pagePath][kwId].ProListTitle;
                        }
                    }
                }
            }
